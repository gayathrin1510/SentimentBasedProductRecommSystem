...
# Loading Vectorizer
vectorizer = pickle.load(file=open(common_utils.tfidf_vectorizer_path, 'rb'))
# Loading Sentiment Classifier
SentimentClassifier = pickle.load(file=open(common_utils.sentiment_classifier_path, 'rb'))
